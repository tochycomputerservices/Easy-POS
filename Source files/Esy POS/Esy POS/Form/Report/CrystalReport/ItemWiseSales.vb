...
Public Class ItemWiseSales
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Esy_POS.ItemWiseSales.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_SharedDate() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedItemWiseSales
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ItemWiseSales = New ItemWiseSales()
        rpt.Site = Me.Site
        Return rpt
    End Function
