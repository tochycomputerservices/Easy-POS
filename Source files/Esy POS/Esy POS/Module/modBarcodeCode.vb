Module modBarcodeCode
    Function Code128(ByVal TheText As String, ByVal prodcutName As String, ByVal pdPrice As String, ByVal CodeLetter As String) As Image
        ...
        End Select
        Binaryz = Binaryz & "0011100010100"
        Dim bmp As Bitmap = New Bitmap(185, 64, System.Drawing.Imaging.PixelFormat.Format24bppRgb)
        Dim z As String
        ...
        For I = 1 To Len(Binaryz)
            ...
            If z = "0" Then
                ...
                point1 = New Point(I, 14)
                point2 = New Point(I, 35)
            ...
            End If
        Next
        GraphZ.DrawString(prodcutName, New Font("Tahoma", 7, FontStyle.Regular), New SolidBrush(Color.Black), 0, 0)
        GraphZ.DrawString(TheText, New Font("Tahoma", 8, FontStyle.Regular), New SolidBrush(Color.Black), 0, 36)
        GraphZ.DrawString("" & pdPrice, New Font("Tahoma", 8, FontStyle.Regular), New SolidBrush(Color.Black), 90, 36)
        Code128 = bmp
    End Function
